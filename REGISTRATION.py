...
firstw=Tk()
firstw.title("Dr. Ambedkar College Deekshabhumi, Nagpur")
firstw.geometry("1600x1000+0+0")
label=Label(text="Dr. Ambedkar College Deekshabhumi, Nagpur",font=("times new roman",35),bg="MediumOrchid2")
...
def second():
    global secondw
    secondw=Tk()
    secondw.title("Dr. Ambedkar College Deekshabhumi, Nagpur")
    ...
    def distroy5():
        secondw.destroy()
        window()
    mainlabel= Label(secondw,text="Dr. Ambedkar College Deekshabhumi, Nagpur", font=("times new roman", 35), bg="MediumOrchid2")
    mainlabel.pack(side=TOP, fill=X)
...
def distroy():
    firstw.destroy()
def login():
    if user.get()=="Pratik" and user3.get()=="Shweta":
        second()
        distroy()
...
def root():
    ...
    root.title("Dr. Ambedkar College Deekshabhumi, Nagpur")
    global entry1
    global entry2
    global entry3
    global entry4
    ...
    label3=Label(root,text=":", font=("arial",17))
...
#================================droplist======================================
    ...
    box['values']=['SELECT','BCA','MANAGEMENT','LAW','BSC']
    box.current(0)
...
def enquiry1():
    ...
    box2['values'] = ['SELECT', 'TO LEARN PROGRAMMING', 'WHAT ARE THE PROCESS FOR ADMISSION', 'FEE DETAILS']
    box2.current(0)
...
def calculation():
 ...
 if NAME==("") and  SUR==("")and  EMAIL==("") and BOX==("SELECT") and  GANDER==(3) and  JAVA==(0) and  PYTHON==(0) and C==(0) and  D==(0):
     ...
     global x
     if box.get()=="BCA" and gander.get()==0:
         x=(calculation2-calculation2*20/100)
         entry5.configure(state="normal")
         entry5.delete(0,END)
         entry5.insert(0,x)
         entry5.configure(state="disable")
     if box.get()=="BCA" and gander.get()==1:
         x=(calculation2-calculation2*10/100)
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="MANAGEMENT" and gander.get()==1:
         x=(calculation2)
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="MANAGEMENT" and gander.get()==0:
         x=(calculation2-calculation2*10/100)
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="BSC" and gander.get()==0:
         x=(calculation2-calculation2*10/100)
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
     ...
     if box.get()=="LAW" and gander.get()==1:
         x=(calculation2)
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
     if box.get()=="LAW" and gander.get()==0:
         x=(calculation2-2*10/100)
         entry5.configure(state="normal")
         entry5.delete(0, END)
         entry5.insert(0, x)
         entry5.configure(state="disable")
